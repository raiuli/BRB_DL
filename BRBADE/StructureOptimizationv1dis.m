...
f_k=objFunAllParallelDisv1(cell2mat(brbParas(k)),brbConfigdatas(k));
f_l=objFunAllParallelDisv1(cell2mat(brbParas(l)),brbConfigdatas(l));
...
for i=2:size(brbStructs(k).antRefval,1)
     newStructure.antRefval(i,:)={theta_new};
end     
